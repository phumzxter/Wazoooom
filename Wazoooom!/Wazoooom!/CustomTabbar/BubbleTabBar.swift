...
open class BubbleTabBar: UITabBar {
    ...
    private func reloadViews() {
        ...
        if #available(iOS 11.0, *) {
            buttons.first?.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 60).isActive = true
            buttons.last?.trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -60).isActive = true
        } else {
            buttons.first?.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 40).isActive = true
            buttons.last?.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -40).isActive = true
        }
